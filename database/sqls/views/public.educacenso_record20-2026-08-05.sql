...
SELECT
    ...
    (
      SELECT array_agg(DISTINCT codigo_educacenso)
        ...
        JOIN modules.area_conhecimento ac ON ac.id = cc.area_conhecimento_id
      ...
      WHERE t.cod_turma = turma.cod_turma
        ...
        AND coalesce(ac.agrupar_descritores, false) = false
    ...
    turma.codigo_eixo_curso_profissional as "codigoEixoCursoProfissional",
    turma.carga_horaria_curso as "cargaHorariaCurso",
