...
class clsPmieducarConfiguracoesGerais
{
    ...
    public function __construct($ref_cod_instituicao = null, $campos = [])
    {
        ...
        // *** LISTA DE CAMPOS ATUALIZADA COM OS NOVOS CAMPOS ***
        ...
        active_on_ieducar, ieducar_image, ieducar_background_image, ieducar_background_image_url, ieducar_entity_name, ieducar_login_footer,
        ...
        emitir_ato_criacao_credenciamento, url_diario_professor, url_whatsapp, mostrar_botoes_ajuda_login';
    ...
    public function edita()
    {
        ...
        if (isset($this->ieducar_image)) {
            $ieducar_image = pg_escape_string($this->ieducar_image);
            $set[] = "ieducar_image = '{$ieducar_image}'";
        }

        if (isset($this->ieducar_background_image)) {
            $ieducar_background_image = pg_escape_string($this->ieducar_background_image);
            $set[] = "ieducar_background_image = '{$ieducar_background_image}'";
        }

        if (isset($this->ieducar_background_image_url)) {
            $ieducar_background_image_url = pg_escape_string($this->ieducar_background_image_url);
            $set[] = "ieducar_background_image_url = '{$ieducar_background_image_url}'";
        }
        ...
        if (isset($this->url_diario_professor)) {
            $url_diario = pg_escape_string(trim($this->url_diario_professor));
            if (empty($url_diario)) {
                $set[] = "url_diario_professor = NULL";
            } else {
                $set[] = "url_diario_professor = '{$url_diario}'";
            }
        }

        if (isset($this->url_whatsapp)) {
            $url_whats = pg_escape_string(trim($this->url_whatsapp));
            if (empty($url_whats)) {
                $set[] = "url_whatsapp = NULL";
            } else {
                $set[] = "url_whatsapp = '{$url_whats}'";
            }
        }
