...
class EducacensoExportController extends ApiCoreController
{
    ...
    protected function exportaDadosRegistro30($escolaId, $ano)
    {
        ...
        foreach ($pessoas as $pessoa) {
            ...
            $data = $this->buildRegistro30ExportData($pessoa, $ano);
    ...
    protected function exportaDadosRegistro60($escolaId, $ano)
    {
        ...
        foreach ($alunos as $aluno) {
            ...
            $data = $this->buildRegistro60ExportData($aluno, $ano);
    ...
    /**
     * @param Registro30 $pessoa
     */
    protected function buildRegistro30ExportData($pessoa, $ano)
    {
        $data = [
            $pessoa->registro,
            $pessoa->inepEscola,
            ...
            $pessoa->transtorno,
            $pessoa->transtornoDiscalculia,
            $pessoa->transtornoDisgrafia,
            $pessoa->transtornoDislalia,
            $pessoa->transtornoDislexia,
            $pessoa->transtornoTdah,
            $pessoa->transtornoTpac,
            $pessoa->recursoLedor,
        ...
        if (CensoLayout2026::isEnabled((int) $ano)) {
            $data[] = $pessoa->formacaoContinuadaAlfabetizacao;
            $data[] = $pessoa->formacaoContinuadaAnosIniciaisFundamental;
            $data[] = $pessoa->formacaoContinuadaAnosFinaisFundamental;
            $data[] = $pessoa->formacaoContinuadaEnsinoMedio;
            $data[] = $pessoa->formacaoContinuadaEducacaoJovensAdultos;
            $data[] = $pessoa->formacaoContinuadaEducacaoEspecial;
            $data[] = $pessoa->formacaoContinuadaEducacaoIndigena;
            $data[] = $pessoa->formacaoContinuadaEducacaoCampo;
            $data[] = $pessoa->formacaoContinuadaEducacaoAmbiental;
            $data[] = $pessoa->formacaoContinuadaEducacaoDireitosHumanos;
            $data[] = $pessoa->formacaoContinuadaEducacaoBilingueSurdos;
            $data[] = $pessoa->formacaoContinuadaEducacaoTecnologiaInformacaoComunicacao;
            $data[] = $pessoa->formacaoContinuadaEducacaoIntegralTempoIntegral;
            $data[] = $pessoa->formacaoContinuadaGeneroDiversidadeSexual;
            $data[] = $pessoa->formacaoContinuadaDireitosCriancaAdolescente;
            $data[] = $pessoa->formacaoContinuadaEducacaoRelacoesEticoRaciais;
            $data[] = $pessoa->formacaoContinuadaEducacaoGestaoEscolar;
            $data[] = $pessoa->formacaoContinuadaEducacaoOutros;
            $data[] = $pessoa->formacaoContinuadaEducacaoNenhum;
            $data[] = $pessoa->email;
        ...
        return array_merge($data, [
            ...
            $pessoa->formacaoContinuadaEducacaoTecnologiaInformacaoComunicacao,
    ...
    /**
     * @param Registro60 $aluno
     */
    protected function buildRegistro60ExportData($aluno, $ano)
    {
        $data = [
            $aluno->registro,
            $aluno->inepEscola,
        ...
        if (CensoLayout2026::isEnabled((int) $ano)) {
            $data[] = $aluno->cargaHorariaIntegralizada;
        }
